...
2.  **CRITICAL: Differentiate Ghanaian Staples**: Your ability to correctly identify staple foods is essential. Do NOT confuse them.
    ...
    *   Under no circumstances should you mistake Fufu for Banku, or vice-versa. Your identification must be precise. Do not use generic terms like "dumpling". Use the correct Ghanaian name.
