...
export const NUTRIENT_LABELS: Record<MicronutrientKey, string> = {
  // Minerals
  calcium: 'Calcium — Macromineral',
  iron: 'Iron — Trace Mineral',
  potassium: 'Potassium — Electrolyte',
  magnesium: 'Magnesium — Macromineral',
  zinc: 'Zinc — Trace Mineral',
  phosphorus: 'Phosphorus — Macromineral',
  iodine: 'Iodine — Trace Mineral',
  selenium: 'Selenium — Trace Mineral',
  copper: 'Copper — Trace Mineral',
  manganese: 'Manganese — Trace Mineral',
  chromium: 'Chromium — Trace Mineral',
  molybdenum: 'Molybdenum — Trace Mineral',
  chloride: 'Chloride — Electrolyte',
  sodium: 'Sodium — Electrolyte',

  // Vitamins
  vitaminA: 'Vitamin A — Fat-Soluble',
  vitaminC: 'Vitamin C — Water-Soluble',
  vitaminD: 'Vitamin D — Fat-Soluble',
  vitaminE: 'Vitamin E — Fat-Soluble',
  vitaminK: 'Vitamin K — Fat-Soluble',
  vitaminB1: 'Thiamine (B1) — B-Complex',
  vitaminB2: 'Riboflavin (B2) — B-Complex',
  vitaminB3: 'Niacin (B3) — B-Complex',
  vitaminB5: 'Pantothenic Acid (B5) — B-Complex',
  vitaminB6: 'Vitamin B6 — B-Complex',
  vitaminB7: 'Biotin (B7) — B-Complex',
  folate: 'Folate (B9) — B-Complex',
  vitaminB12: 'Vitamin B12 — B-Complex',
