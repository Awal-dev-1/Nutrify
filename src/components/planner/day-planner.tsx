...
import { Plus, Trash2, Pencil, Calendar, Utensils, Beef, Wheat, Droplets, UtensilsCrossed, MoreVertical } from 'lucide-react';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { MacroStat } from '@/components/tracker/macro-stat';
          ...
          <Card className="border-2 shadow-lg">
            ...
            <CardContent className="grid gap-5 sm:gap-6">
              ...
              <div className="space-y-2">
                ...
                <Progress value={Math.min(calorieProgress, 100)} className="h-1.5" indicatorClassName={calorieProgress > 100 ? 'bg-amber-500' : 'bg-primary'} />
              </div>
        ...
        >
          <Accordion type="multiple" defaultValue={mealTypes} className="space-y-3 sm:space-y-4">
           ...
           {mealsForDay.length === 0 && (
             <EmptyState title="No meals planned for today" description="Start planning your day by adding meals.">
